...
// GetLoansByMobile retrieves loans by user's mobile number
func GetLoansByMobile(mobile string, pageNo int, pageSize int) (*loan.LoanListResponse, error) {
